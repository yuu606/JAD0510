...
<article class="container-fluid p-4 px-5">
	<div class="row">
		...
		<div class="col-9">
			...
			<div class="row"
				style="border-bottom: 1px solid; border-color: darkolivegreen;">
				<h3 class="display-6" id="Cost">$<%= Price%></h3>
			</div>
			<div class="row"
				style="border-bottom: 1px solid; border-color: darkolivegreen;">
				<h5 style="color: darkblue;">Quantity: <%= Quantity%></h5>
			</div>

			<!--part 2 -->
			<div class="row"
				style="border-bottom: 1px solid; border-color: darkolivegreen; margin-top: 5%;">
				<h5 id="Genre" class="col-4">Genre: <%= genre_name%></h5>
				<h5 id="Rating" class="col-2">Rating: <%= Rating %></h5>
			</div>
			<div class="row"
			...
			<div class="row row-cols-3"
				...
				<h6 id="PublishBy" class="col">
					Published by:<br> <%= Publisher %>
				</h6>
				<h6 id="PublishOn" class="col">
					Published on (DD-MM-YY):<br> <%= Publication_Date %>
				</h6>
