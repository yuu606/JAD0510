          ...
          <ul class="dropdown-menu">
            ...
            <li><a class="dropdown-item" href="../public/genrePage.jsp?search=classic">Classic</a></li>
				...
				<button class="btn btn-outline-success"
					...
					onclick="window.location.href='../public/logOut.jsp'">
					Logout</button>
				<button class="btn btn-outline-success"
					style="font-family: Monaco, monospace; font-weight: bold; margin: 10px;"
					onclick="window.location.href='membersPage.jsp'">Profile</button>
				<%
				} else {
				%>
				<button class="btn btn-outline-success"
					style="font-family: Monaco, monospace; font-weight: bold; margin: 10px;"
					onclick="window.location.href='../public/Login.jsp'">
					Login</button>
				<button class="btn btn-outline-success"
					style="font-family: Monaco, monospace; font-weight: bold; margin: 10px;"
					onclick="window.location.href='../public/signUp.jsp'">
					Sign Up</button>
				<%
				}
				%>
				<form class="d-flex"
					action="${pageContext.request.contextPath}/ProcessSearch"
