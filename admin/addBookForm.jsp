...
-->
	<div class="container-fluid">
		...
		<!-- -----------------END OF HEADER-----------------  -->
		<form name="Edit" action="manageBooks.jsp?command=add" method="post">
			<div class="container-fluid p-3">
				<div class="col-10" style="margin-left: auto; margin-right: auto;">
					<table class="table table-bordered table-hover">
						<tr>
							<td class="col-2">ISBN:</td>
						...
						<tr>
							...
							<td><input class="form-control" type="number" name="Rating"
								min="0" max="5" step="0.1"></td>
						</tr>
						<tr>
							<td>Description:</td>
							<td><textarea class="form-control" name="Description"></textarea>
						</tr>

					</table><input class="btn btn-success mx-1"  type="submit"
								name="btnSubmit" value="Add">
				</div>
			</div>
		</form>
		<%
