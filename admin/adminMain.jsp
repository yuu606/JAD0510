		...
		<div class="row align-items-center height">
			<div class="container-fluid d-flex flex-column px-5 py-2">
				<div class="row">
					<button class="btn btn-success text-nowrap"
						style="font-family: Monaco, monospace; font-weight: bold;"
						onclick="window.location.href='uploadImageForm.jsp'">Add
						New Book</button>
				</div>
				<div class="row">
					<table class="table table-bordered table-hover">
						...
						<tr>
							...
							<td><%=Rating%></td>
							<td><%=Description%></td>
							<td><a role="button" href="editBook.jsp?isbn=<%=isbn%>"
								class="btn btn-primary">Edit</a></td>
							<td><a role="button"
								href="manageBooks.jsp?command=delete&isbn=<%=isbn%>"
				...
				<div class="row">
					<button class="btn btn-success text-nowrap"
						style="font-family: Monaco, monospace; font-weight: bold;"
						onclick="window.location.href='addCustomerForm.jsp'">Add
						New Customer</button>
				</div>
				<div class="row">
					<table class="table table-bordered table-hover">
						...
						<tr>
							...
							<td><%=Password%></td>
							<td><a role="button"
								href="editCustomer.jsp?userID=<%=userID%>&custID=<%=customerID%>">Edit</a></td>
							<td><a role="button"
								href="manageUsers.jsp?command=delete&userID=<%=userID%>">Delete</a></td>
						</tr>
						<%
						}
						connection.close();
