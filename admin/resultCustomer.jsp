...
<body>
	<div class="container-fluid">
		...
		if (request.getParameter("deletedCust") != null) {
			...
			out.print("You have deleted customer " + deletedCust);
		} else {
			int userID = 0;
			String sql = "";
			...
			try {
				...
				sql = "SELECT c.Customer_Id, c.Email, c.First_Name, c.Last_Name, c.Address, u.Username, u.Password FROM customers c, users u WHERE c.User_Id = u.User_Id and c.User_Id = ?";
		...
		%>		<button class="btn btn-success  text-nowrap"
			style="font-family: Monaco, monospace; font-weight: bold;"
			onclick="window.location.href='adminMain.jsp'">Back to main
			admin page</button>
	</div>
